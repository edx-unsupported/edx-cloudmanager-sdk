...
class Host(CloudManagerBase):
    ...
    my_api_attributes = ['alerts_enabled', 'auth_mechanism_name', 'cluster_id', 'deactivated', 'has_startup_warnings', 'hidden', 'host_enabled', 'hostname', 'ip_address', 'journaling_enabled', 'last_data_size_bytes', 'last_index_size_bytes', 'last_ping', 'last_reactivated', 'last_restart', 'logs_enabled', 'low_ulimit', 'munin_enabled', 'password', 'port', 'profiler_enabled', 'replica_set_name', 'replica_state_name', 'ssl_enabled', 'type_name', 'uptime_msec', 'username', 'version']
